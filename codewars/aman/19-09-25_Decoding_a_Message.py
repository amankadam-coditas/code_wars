"""
Question Link : https://www.codewars.com/kata/565b9d6f8139573819000056/train/python
<| 7 kyu |> | 19th Sept '25
...
def decode(message):
    ...
    map_dict = { k:i+1 for i,k in enumerate(alphabets)}
    decoded_msg = ""
    for char in message:
        if char.isalpha():
            decoded_msg += alphabets[-map_dict[char]]
        else:
            decoded_msg += char
    return decoded_msg
